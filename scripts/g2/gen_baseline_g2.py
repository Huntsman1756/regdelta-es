"""G2.0 target-specific literal baseline for src/regdelta at HEAD.

Identical scan to scripts/g1/gen_baseline_g1.py; writes the G2
baseline to evidence/g2/runtime-literals-baseline.json so the G2
guard asserts the delta against THIS gate's base, not an older one.

Usage: uv run python -X utf8 scripts/g2/gen_baseline_g2.py
"""
