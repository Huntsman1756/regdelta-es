"""G2 anti-hardcoding guard: no NEW target-specific literals.

Same delta rule as the G0/G1 guards, keyed to the G2.0 base HEAD:
current literals(src/regdelta) - evidence/g2 baseline = empty.
"""
...
BASELINE = ROOT / "evidence" / "g2" / "runtime-literals-baseline.json"
